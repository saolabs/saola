...
<p @class([$__VIEW_ID__ . '-4d8330ac'])>Template, state, script và style hội tụ ở định dạng <code @class([$__VIEW_ID__ . '-0a67dfc3'])>.sao</code>. Quên việc nhảy qua lại giữa file Blade và component Vue/React.</p>
@exec($__env->stopSection())
@exec($__mapcard__0_content = $__env->yieldContent($__ONE_COMPONENT_REGISTRY__['mapcard'].'_0'))
@include('web.modules.home.parts.mapcard', ['eyebrow' => "01 / SINGLE FILE", 'title' => "Mọi thứ trong một file", 'href' => "/docs/sao-file", 'link' => "Xem cấu trúc .sao ↗", '__ONE_CHILDREN_CONTENT__' => $__mapcard__0_content])
@endMarker('component', 'c26ee094')
            @startMarker('component', 'bdd4cecc')
            @exec($__env->startSection($__ONE_COMPONENT_REGISTRY__['mapcard'].'_1'))
<p @class([$__VIEW_ID__ . '-37aeefe2'])>Server trả về HTML hoàn chỉnh ngay lần tải đầu. Trải nghiệm tức thì cho người dùng và crawler, không có khoảng trắng khó chịu.</p>
@exec($__env->stopSection())
@exec($__mapcard__1_content = $__env->yieldContent($__ONE_COMPONENT_REGISTRY__['mapcard'].'_1'))
@include('web.modules.home.parts.mapcard', ['eyebrow' => "02 / TỐI ƯU SEO", 'title' => "SSR được cấu hình sẵn", 'href' => "/docs/lifecycle", 'link' => "Cơ chế hydration ↗", '__ONE_CHILDREN_CONTENT__' => $__mapcard__1_content])
...
@include('web.modules.home.parts.mapcard', ['eyebrow' => "03 / REACTIVE TỰ NHIÊN", 'title' => "Không Virtual DOM", 'href' => "/docs/reactivity", 'link' => "State & reactivity ↗", 'variant' => "dark", '__ONE_CHILDREN_CONTENT__' => $__mapcard__2_content])
