...
<?php if(!array_key_exists('label', get_defined_vars())) $label = 'Label'; if(!array_key_exists('value', get_defined_vars())) $value = '0'; if(!array_key_exists('tone', get_defined_vars())) $tone = 'sky'; ?>
@wrapper
