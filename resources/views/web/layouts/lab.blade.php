        ...
        <div @class([$__VIEW_ID__ . '-Bcontent1', 'lab-shell'])>
            <aside @class([$__VIEW_ID__ . '-Bcontent11', 'docs-nav']) @attr(['aria-label' => 'Điều hướng trang demo'])>
                <div @class([$__VIEW_ID__ . '-Bcontent111', 'docs-nav-inner'])>
                    ...
                    <a @class([$__VIEW_ID__ . '-Bcontent111e12_']) @attr(['href' => '/demo/grid'])>Bảng dữ liệu 3.800 dòng</a>
                    <a @class([$__VIEW_ID__ . '-Bcontent111e13_']) @attr(['href' => '/demo/stream'])>Luồng sự kiện SSE</a>
                    ...
                    <a @class([$__VIEW_ID__ . '-Bcontent111e14_']) @attr(['href' => '/roster'])>Roster — CRUD qua API</a>
                    <a @class([$__VIEW_ID__ . '-Bcontent111e15_']) @attr(['href' => '/todo-list'])>Todo — state cục bộ</a>

                    <p @class([$__VIEW_ID__ . '-Bcontent111e16_', 'docs-nav-group'])>Tài liệu</p>
                    <a @class([$__VIEW_ID__ . '-Bcontent111e17_']) @attr(['href' => '/docs/directives'])>Tham chiếu directive</a>
                    <a @class([$__VIEW_ID__ . '-Bcontent111e18_']) @attr(['href' => '/docs/status'])>Giới hạn đã biết</a>
                </div>
            </aside>
