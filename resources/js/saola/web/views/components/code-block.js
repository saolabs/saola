...
const __VIEW_PATH__ = 'web.components.code-block';
...
class CodeBlockViewController extends ViewController {
    constructor(view) {
...
class CodeBlockView extends View {
    constructor(__data__ = {}, systemData = {}) {
        super(__VIEW_PATH__, __VIEW_TYPE__, CodeBlockViewController);
        const App = app("App");
        ...
        let {lang = 'none', dark = true, __ONE_CHILDREN_CONTENT__ = ''} = __data__;
        ...
        const __VARIABLE_LIST__ = ["lang", "dark", "__ONE_CHILDREN_CONTENT__"];
        ...
        this.__ctrl__.setup({
            ...
            this.html(`e1`, "div", parentElement,
                { classes: [{ type: 'static', value: "code-block" }, { type: 'binding', value: "code-block-dark", factory: () => dark, stateKeys: ["dark"] }] },
                (parentElement) => [
...
export function WebComponentsCodeBlock(__data__ = {}, systemData = {}) {
    return new CodeBlockView(__data__, systemData);
}
export default WebComponentsCodeBlock;