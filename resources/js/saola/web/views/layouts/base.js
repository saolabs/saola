...
class BaseViewController extends ViewController {
    constructor(view) {
...
class BaseView extends View {
    constructor(__data__ = {}, systemData = {}) {
        super(__VIEW_PATH__, __VIEW_TYPE__, BaseViewController);
        const App = app("App");
...
export function WebLayoutsBase(__data__ = {}, systemData = {}) {
    return new BaseView(__data__, systemData);
}
export default WebLayoutsBase;
